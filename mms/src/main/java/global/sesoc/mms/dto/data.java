...
public class data {
	...
	public data(long pnum, String userid, long num, String desc_kor, float nutr_cont1, float nutr_cont2,
	...
	public String toString() {
		return "data [pnum=" + pnum + ", userid=" + userid + ", num=" + num + ", desc_kor=" + desc_kor
